...
- When `StackSelection.integrations` contains `img2threejs`, load the `img2threejs` skill, run the staged forge pipeline from the skill root, and emit the Three.js factory only into the generated workspace.
