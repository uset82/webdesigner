...
- Use the Shadcn CLI and the official `@animate-ui/...` registry items. Never copy raw component files from GitHub.
...
- Preserve existing design tokens, aliases, component conventions, and package-manager choice.
...
2. Inspect the generated workspace, package manager, `components.json`, Tailwind setup, and motion plan.
